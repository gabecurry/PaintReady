let timeRemaining = 300;
    ...
    const suspects = [
      ...
      {
        name: "Gabriel DuPont",
        backstory: "A cynical art critic known for his biting reviews and disdain for modern museum practices. His latest exposé targeted the museum’s inadequate security measures, sparking controversy.  Gabriel's public criticism of the museum may have been a smokescreen for planning the heist. Some believe he wanted to embarrass the institution and prove his theories right.",
        clues: [
      ...
      {
        name: "Abel Kane",
        backstory: "A suave and charismatic philanthropist with a dark past. Abel has been implicated in several high-profile art thefts but has never been convicted.   Abel's charm allowed him to manipulate staff and guests alike, but his unexplained interactions with a black-market art dealer are hard to ignore.",
        clues: [
      ...
      {
        name: "Deb Rivera",
        backstory: "A seasoned security guard with a spotless record—until now. Deb's involvement in previous museum incidents has always been dismissed as coincidence.  Deb's financial troubles and recent disciplinary actions might have pushed him to make a desperate move.  Deb left her post during the blackout and was seen exiting the building shortly before the Picasso was discovered missing.",
        clues: [
          "Witnesses saw her leaving the gala unusually early.",
          "The keycard logs show unauthorized access from her ID.",
          "Her uniform had traces of paint matching the stolen frame.",
          "Her bank account received a sudden large deposit after the theft."
        ]
      },
      {
        name: "Heather Lang",
        backstory: "A rising star in the art world, Heather has gained fame for her provocative works critiquing institutional art culture. She has accused the museum of neglecting contemporary artists.  Heather's public feud with the museum made her a prime suspect. She claimed stealing The Dreamer would force the institution to “acknowledge true artistry.”  Heather was seen carrying an oversized bag, and her cryptic comments about “making history” have fueled speculation.",
        clues: [
      ...
      },
      {
        ...
        backstory: "A rival museum director with a deep rivalry against the Metropolitan Art Museum. Travis has often expressed envy over their superior collection.  Stealing The Dreamer would deal a devastating blow to his competitors and elevate the prestige of his own museum.  Travis' late-night meetings with unidentified individuals and his access to blueprints of the museum make him a strong suspect.",
        clues: [
